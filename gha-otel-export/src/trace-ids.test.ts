...
describe("otel ID generation", () => {
  ...
  it("GenerateStepSpanID (by name)", () => {
    ...
    const actual = generateStepSpanID(runId, runAttempt, jobName, stepName)
  ...
  it("GenerateStepSpanID (by number)", () => {
    ...
    const actual = generateStepSpanID_Number(runId, runAttempt, jobName, stepNumber)
  ...
  it("Deterministic output", () => {
    ...
    const step1 = generateStepSpanID(runId, runAttempt, jobName, stepName)
    const step2 = generateStepSpanID(runId, runAttempt, jobName, stepName)
